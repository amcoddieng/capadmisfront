...
const PJ_TYPES = [
  ...
  { value: 'BULLETIN_NOTES_SECONDE1', label: 'Bulletin — Seconde Semestre 1' },
  { value: 'BULLETIN_NOTES_SECONDE2', label: 'Bulletin — Seconde Semestre 2' },
  { value: 'BULLETIN_NOTES_PREMIERE1', label: 'Bulletin — Première Semestre 1' },
  { value: 'BULLETIN_NOTES_PREMIERE2', label: 'Bulletin — Première Semestre 2' },
  { value: 'BULLETIN_NOTES_TERMINALE1', label: 'Bulletin — Terminale Semestre 1' },
  { value: 'BULLETIN_NOTES_TERMINALE2', label: 'Bulletin — Terminale Semestre 2' },
  { value: 'BULLETIN_NOTES_BT1_S1', label: 'Bulletin — BT1 Semestre 1' },
  { value: 'BULLETIN_NOTES_BT1_S2', label: 'Bulletin — BT1 Semestre 2' },
  { value: 'BULLETIN_NOTES_BT2_S1', label: 'Bulletin — BT2 Semestre 1' },
  { value: 'BULLETIN_NOTES_BT2_S2', label: 'Bulletin — BT2 Semestre 2' },
  { value: 'BULLETIN_NOTES_BT3_S1', label: 'Bulletin — BT3 Semestre 1' },
  { value: 'BULLETIN_NOTES_BT3_S2', label: 'Bulletin — BT3 Semestre 2' },
