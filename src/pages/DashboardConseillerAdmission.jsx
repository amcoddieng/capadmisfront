...
export default function DashboardConseillerAdmission() {
  const navigate = useNavigate();
  const { token, personnel } = getPersonnelSession();

  useEffect(() => {
    if (!token || !personnel || personnel.role !== 'conseiller_admission') {
      navigate('/espace-pro');
    }
  }, [navigate]);
  ...
  return (
    <div className="stub-page">
      <div className="stub-page__card">
        <p className="stub-page__role">conseiller_admission</p>
